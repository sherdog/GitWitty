...
/* Tracking ID */
$trackingID  = hesk_input($_POST['orig_track']) or die($hesklang['int_error'].': No orig_track');
...
if (!strlen($message))
{
	hesk_process_messages($hesklang['enter_message'],'ticket.php?track='.$trackingID.'&Refresh='.rand(10000,99999));
}
