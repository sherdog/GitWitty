...
$trackingID = strtoupper(hesk_input($_REQUEST['track'],"$hesklang[int_error]: $hesklang[no_trackID]."));
...
elseif ($owner < 1)
{
    hesk_process_messages($hesklang['nose'],$_SERVER['PHP_SELF']);
}
