...
<textarea name="s_question_ask" rows="3" cols="40"><?php echo addslashes(htmlspecialchars($spam_question[0])); ?></textarea><br />

<?php echo $hesklang['q_a']; ?>:<br />
<input type="text" name="s_question_ans" value="<?php echo addslashes(htmlspecialchars($spam_question[1])); ?>" size="10" />
<?php
exit();
?>
