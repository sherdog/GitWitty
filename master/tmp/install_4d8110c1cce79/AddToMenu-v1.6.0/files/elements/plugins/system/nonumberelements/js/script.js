...
if ( typeof( nn_scripts_version ) == 'undefined' || nnScriptsVersionIsNewer( nn_scripts_version, '2.2.2' ) ) {
	// version number of the script
	// to prevent this from overwriting newer versions if other extensions include the script too
	var nn_scripts_version = '2.2.2';
...
window.addEvent( 'domready', function() {
	// correct widths
	$$( '.width-60, .width-40' ).each( function( el ) {
		el.setStyle( 'width', '50%' );
	});
	$$( '.paramlist_key' ).each( function( el ) {
