...
?>   
   ...
   <tr><td>
   <table class="multisitesparams">
<?php if ( !isset( $this->show_template) || $this->show_template) { ?>
   	<tr valign="top">
   ...
   <?php if ( !empty( $this->row->expiration)) { ?>
            		      <tr>
                     		<td class="helpMenu" align="right" nowrap="nowrap">
...
<?php } else { ?>
   	<tr valign="top" style="display:none"><td><?php echo $this->lists['templates']; ?></td></tr>
<?php }?>
<?php if ( !isset( $this->show_templatedescr) || $this->show_templatedescr) { ?>
   	<tr valign="top">
   		<td class="helpMenu" align="right">
   			<label for="adminUser">
...
<?php } ?>
<?php if ( !isset( $this->show_prefix) || $this->show_prefix) { ?>
   	<tr>
   		<td class="helpMenu" align="right">
   			<label for="id">
...
<?php } ?>
<?php if ( !isset( $this->show_toSiteName) || $this->show_toSiteName) { ?>
   	<tr valign="top">
   		<td class="helpMenu" align="right">
