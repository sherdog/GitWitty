...
class RTMenuHelper {
	...
	function buildMenu()
	{
		...
		$user =& JFactory::getUser();//for ACL custom tabs.
		...
		//$menu->addSeparator();
			...
			if( $user->usertype == "Super Administrator") {
				$menu->addChild(new JMenuNode(JText::_('Page Manager')), true);
				...
				$menu->addChild(new JMenuNode(JText::_('Page Manager'), 'index.php?option=com_content'), true);
			}
		...
		//$menu->addChild(new JMenuNode(JText::_('Joomla! Help'), 'index.php?option=com_admin&task=help', 'help'));
	...
	function buildDisabledMenu()
	{
		...
		// Articles SubMenu
		$menu->addChild(new JMenuNode(JText::_('Page Manager'), null, 'disabled daddy'));
	...
	function __construct() {
		// menu data
		$menus['Dashboard'] = array('com_trash:task=viewContent','com_sections:scope=content','com_categories:section=com_content','com_media','com_frontpage');
		$menus['Page Manager'] = array('com_menus','com_trash:task=viewMenu', 'com_content');
