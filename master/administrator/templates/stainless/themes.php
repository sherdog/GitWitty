...
/**
* @version		$Id:$
* @package		JoomlaPraise.Framework
...
//				$return[] = '<a href="'.$uri->toString().'" style="bordercolor:'.($child->attributes('color')?$child->attributes('color'):$style[1]).';background-color:'.($child->attributes('bgcolor')?$child->attributes('bgcolor'):$style[0]).';">'.$child->data().'</a>';
	...
	&lt;option value="theme1"&gt;Solid Gold&lt;/option&gt;
	&lt;option value="theme2"&gt;Electric Blue&lt;/option&gt;
	&lt;option value="theme3"&gt;Lime Green&lt;/option&gt;
	&lt;option value="theme4"&gt;Alien Purple&lt;/option&gt;
	&lt;option value="theme5"&gt;Nickel Silver&lt;/option&gt;
&lt;/param&gt;</pre>';
		}
	}
}
