...
// Adding submenu for newItem
print "<ul class=\"menusub\"><li>\n";
print "<a id=\"".str_replace(' ','',$menuItem['name'])."\" ".$anchorExtra." href=\"".$href."&task=newItem\">";
print JText::_( 'NEW' ) . " " . $menuItem['name'] . " " . JText::_( 'ITEM' ) . "</a></li></ul>\n";
