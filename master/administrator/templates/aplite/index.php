	...
	<div id="ap-header">
		...
		<div id="ap-mainmenu" class="mr20 fluid">
			...
			<ul>
             ...
             <li><a href="index.php?option=com_k2&view=categories&filter_trash=0">Menu Items</a></li>
             <li><a href="index.php?option=com_k2&view=items">Content</a></li>
             <li><a href="index.php?option=com_media">Media Library</a></li>
             <li><a href="index.php?option=com_jcontacts">Lead Manager</a></li>
				...
				<?php if (($user->get('gid') >= $articlesAcl) && $articlesAcl != 0) { ?><li <?php if ($option =="com_content" || $option == "com_sections" && $sectionsAcl == 0 || ($option =="com_categories" && $scope =="content") && $categoriesAcl == 0 || $option =="com_frontpage") { echo "class=\"active\""; } ?>><a href="index.php?option=com_content">Pages</a></li><?php } ?>
