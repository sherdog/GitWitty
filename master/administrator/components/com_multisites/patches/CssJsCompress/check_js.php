...
/**
 * @file       check_js.php
 * @brief      Check if the 'system/CssJsCompress/js.php' files contains the Multi Sites patches 
...
//	$filename = JPATH_ROOT.DS.$file;
   ...
   /*
      ...
      $file=JPATH_BASE.DS.'cache'.DS.'js'.DS.$jsFileName;
      //_jms2win_end
		........
