...
include_once(dirname(__FILE__).DS.'..'.DS.'default'.DS.'view.html.php');

class MultisitesInstallerViewLayouts extends MultisitesInstallerViewDefault
{
	function display($tpl=null)
	{
		...
		$select[] = JHTML::_('select.option', '0', JText::_('Site Layouts'));
		$select[] = JHTML::_('select.option', '1', JText::_('Admin Layouts'));
