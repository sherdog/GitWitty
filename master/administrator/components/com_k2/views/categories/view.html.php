...
class K2ViewCategories extends JView
{
	...
	function display($tpl = null)
	{
		...
		JSubMenuHelper::addEntry(JText::_('Pages'), 'index.php?option=com_k2&view=items');
		JSubMenuHelper::addEntry(JText::_('Menu Items'), 'index.php?option=com_k2&view=categories', true);
