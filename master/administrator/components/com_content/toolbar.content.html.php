...
class TOOLBAR_content
{
	function _EDIT($edit)
	{
		...
		JToolBarHelper::title( JText::_( 'Page' ).': <small><small>[ '. $text.' ]</small></small>', 'addedit.png' );
		JToolBarHelper::preview( 'index.php?option=com_content&id='.$cid.'&tmpl=component', true );
		//JToolBarHelper::save();
		JToolBarHelper::apply('apply', 'Save Content');
		if ( $edit ) {
...
*/
	...
	function _COPY()
	{
		JToolBarHelper::title( JText::_( 'Copy Pages' ), 'copy_f2.png' );
	...
	function _DEFAULT()
	{
		...
		JToolBarHelper::title( JText::_( 'Page Manager' ), 'article.png' );
