	...
	function editContent( &$row, $section, &$lists, &$sectioncategories, $option, &$form )
	{
	  ...
	  .triangle-border {
			   -moz-border-radius: 10px 10px 10px 10px;
				background: none repeat scroll 0 0 #E5F9C2;
		...
		.triangle-border.top:after {
			...
			right:158px; /* controls horizontal position */
			bottom:auto;
			left:auto;
		...
		.triangle-border.top2:after {
			top:-15px; /* value = - border-top-width - border-bottom-width */
			right:260px; /* controls horizontal position */
			bottom:auto;
			left:auto;
			border-width:0 15px 15px; /* vary these values to change the angle of the vertex */
			border-color: #5A8F00 transparent;
        ...
        Once your are finished, you can attach this page to the menu by clicking on this button
        </p>
        <div style="clear:both; margin:0px; padding:0px; overflow:hidden; display:none;"></div>
		<?php } else {?>
        <p class="triangle-border top2">
       	Add this page to a menu item by clicking on "Add to Menu"
        </p>
        <div style="clear:both; margin:0px; padding:0px; overflow:hidden; display:none;"></div>
        <?php } ?>
