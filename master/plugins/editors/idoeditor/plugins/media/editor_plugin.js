	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceAudio', function() {
				ed.windowManager.open({
					file : url + '/audio.htm',
					width : 355 + parseInt(ed.getLang('media.delta_width', 0)),
					height : 175 + parseInt(ed.getLang('media.delta_height', 0)),
					inline : 1,
					overlay:false
				}, {
					plugin_url : url
			...
			ed.addCommand('mceVideo', function() {
				ed.windowManager.open({
					...
					height : 250 + parseInt(ed.getLang('media.delta_height', 0)),
					inline : 1,
					overlay:false
				}, {
					plugin_url : url
			...
			// Register buttons
			ed.addButton('audio', {title : 'media.audio_desc', cmd : 'mceAudio'});
			ed.addButton('video', {title : 'media.video_desc', cmd : 'mceVideo'});
