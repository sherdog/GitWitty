...
<div class="template" id="template_<?=$i?>">
    <img border="0" src="<?php echo $img_path; ?>" name="imagelib" alt="<?php echo JText::_( 'No preview available' ); ?>" width="206" height="145" />
    <div class="bottom"> <input type="radio" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->directory; ?>" onclick="isChecked(this.checked);" /></div>
    </div>
