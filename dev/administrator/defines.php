...
/**
 * @file       define.php
 * @brief      Create the "define.php" file to setup the parameter for the administrator/index.php
 *
 * @version    1.2.51
...
// -------- Finally defines the values that replace the default Joomla one
//Global definitions.
