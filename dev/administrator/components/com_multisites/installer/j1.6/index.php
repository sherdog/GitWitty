...
foreach ($subMenus as $name => $extension) {
	JSubMenuHelper::addEntry(JText::_( $name ), '#" onclick="javascript:document.adminForm.type.value=\''.$extension.'\'; document.adminForm.view.value=\''.$extension.'\';submitbutton(\'manage\');', ($extension == $ext));
}
