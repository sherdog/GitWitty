 ...
 * @since		1.5
 */
class MultisitesInstallerViewDefault extends JView
{
	...
	function display($tpl=null)
	{
		 ...
		 */
		JToolBarHelper::title( JText::_( 'Layouts manager'), 'install.png' );

		// Document
		$document = & JFactory::getDocument();
		$document->setTitle(JText::_('Layouts manager').' : '.JText::_( $this->getName() ));
