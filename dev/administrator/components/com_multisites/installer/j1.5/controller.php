...
// ===========================================================
//             MultisitesInstallerController class
// ===========================================================
class MultisitesInstallerController extends InstallerController
{
   //------------ cancel ---------------
   /**
    * @brief Redirect to the default multisites page (control panel).
    */
	function cancel()
	{
