...
//------------ jms2win_checkGantryCoreTplDetail ---------------
/**
 * check if following lines are present:
 * - if ( defined( 'MULTISITES_ID') ...
 *   is present
 */
function jms2win_checkGantryCoreTplDetail( $model, $file)
{
...
//------------ jms2win_actionGantryCoreTplDetail ---------------
/**
 * @brief Install the patch
 */
function jms2win_actionGantryCoreTplDetail( $model, $file)
{
   ...
   $patchStr = jms2win_loadPatch( '..' .DS. 'gantry' .DS. 'patch_gantrycoretpldetail.php');
   if ( $patchStr === false) {
      return false;
   }
