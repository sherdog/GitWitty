           ...
           <script language="javascript" type="text/javascript">   
            ...
            <tr>
                ...
                <fieldset>      
					...
					?>
                       <tr bgcolor="<?php echo($k==0)?"#f9f9f9":"#eeeeee";?>">					   
							...
							<td><input class="inputbox" type="text" size="15" maxlength="255"  id="title_<?php echo $i; ?>" name="title[]" value="" ></td>   
							
						<?php if ($this->params->get('displayAlias')==1 ){ ?>							
							<td><?php echo JText::_("ALIAS");?></td>							
							<td><input class="inputbox" type="text" size="15" maxlength="255"  id="alias_<?php echo $i; ?>" name="alias[]" value="" ></td>   
						<?php } 
								else 
						...
						<?php if ($this->params->get('displayIntroText')==1 ){ ?>
                         <tr bgcolor="<?php echo($k==0)?"#f9f9f9":"#eeeeee";?>">
							...
							<?php if (($i==1 && $this->params->get('displayWysiwyg')=="1") ||$this->params->get('displayWysiwyg')=="2" ) echo "<td colspan=\"4\">".$editor->display( 'introtext_'.$i, "" ,'50%', '50', '20', '50' )."</td></tr><tr>" ; 
	                            ...
	                            <td><textarea id="<?php echo 'introtext_'.$i;?>" name="<?php echo 'introtext_'.$i;?>" rows="4" cols="10"></textarea></td>
								<?php } 
							} 
							else 
                            ...
                            <td><textarea id="<?php echo 'fulltext_'.$i;?>" name="<?php echo 'fulltext_'.$i;?>" rows="4" cols="10"></textarea></td><?php }
							}
							else 
              ...
              <tr>	
                            ...
                            <td><textarea id="metadesc_<?php echo $i; ?>" name="metadesc[]" rows="1" cols="10"></textarea></td><?php }
							else 
                            ...
                            <td><textarea id="metakey_<?php echo $i; ?>" name="metakey[]" rows="1" cols="10"></textarea></td><?php }
							else 
